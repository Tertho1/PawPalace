...
<body>
    ...
    <div class="profile-page">
        <div class="profile-card-left">
            ...
            <a href="user-posts.php?user_id=<?php echo $user_id; ?>" class="posts-btn">View Posts</a> <!-- Posts Button -->
        </div>
        <div class="profile-card-right">
            <form class="profile-form" method="POST" action="update-profile.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="contact-number" value="<?php echo htmlspecialchars($user['contact_number']); ?>">
